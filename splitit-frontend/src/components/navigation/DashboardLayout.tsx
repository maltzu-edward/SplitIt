...
function DashboardLayout() {
    ...
    return (
        <div className="flex min-h-screen bg-background text-on-surface select-none">
            ...
            {/* Main Canvas */}
            <div className="flex-1 ml-64 min-h-screen relative flex flex-col z-10">
                ...
                {/* TopNavBar Component */}
                <header className="fixed top-0 right-0 left-64 z-40 flex justify-between items-center pl-8 pr-6 bg-surface/40 backdrop-blur-md h-16 border-b border-white/10 shadow-sm">
                    <div className="flex items-center gap-4 w-1/3">
                        <div className="relative w-full max-w-sm">
                            ...
                            <input
                                className="w-full bg-white/5 border border-white/10 rounded-full py-2 pl-10 pr-4 text-label-md focus:outline-none focus:border-primary-container/50 transition-colors text-on-surface placeholder-on-surface-variant/40"
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button
                            onClick={toggle}
                            className="text-on-surface-variant hover:bg-white/10 p-2 rounded-full transition-colors cursor-pointer flex items-center justify-center"
                        ...
                        <button 
                            ...
                            className="relative text-on-surface-variant hover:bg-white/10 p-2 rounded-full transition-colors cursor-pointer flex items-center justify-center"
                        >
                            <span className="material-symbols-outlined">notifications</span>
                            {notificationCount > 0 && (
                                <span className="absolute top-1 right-1 w-4.5 h-4.5 bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center border border-background">
                                    {notificationCount}
                                </span>
                            )}
                        </button>
